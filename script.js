...
/* Cycles through roles in the hero subheading. Purely decorative —
   respects prefers-reduced-motion by freezing on the first role. */
...
if (roleTextEl && !prefersReducedMotion) {
    ...
    // start the cycle after the initial static role has been shown briefly
    setTimeout(() => {
        deleting = true;
        tickRole();
    }, 1800);
